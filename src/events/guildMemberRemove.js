...
module.exports = async (member) => {
  ...
  if (!inviteMemberData) {
    channel.wsend(`\`${member.user.tag}\` sunucumuzdan ayrıldı ama kim tarafından davet edildiğini bulamadım.<:cikis:1041764110779568198>`);
  } else {
    ...
    channel.wsend(`\`${member.user.tag}\` sunucumuzdan ayrıldı. ${inviter.tag} tarafından davet edilmişti. (**${total}** davet) <:cikis:1041764110779568198>`);
