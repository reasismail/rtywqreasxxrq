...
moment.locale("tr");
const adonisayar = require('../../configs/sunucuayar.json')
...
run: async (client, message, args, embed, prefix) => {
  ...
  if (message.member.permissions.has("ADMINISTRATOR")) {
    ...
    message.guild.channels.cache.get(adonisayar.voiceLogChannel).wsend(log);
} else {
...
let msg = await message.channel.send((member.toString()), { components : [ row ], embed: adonis})
